<?php require_once ('application/bddConnect/singletonbdd.php');?>
<!DOCTYPE HTML>
<html>
    <head>
    <meta charset="UTF-8">
...
<header class="toppage">
    <div class="container">
        <a href="index.php"><img class="logoimies pull-left" alt="IMIESpere" src="assets/img/Imie_sphere.jpg" /></a>
        <h2 class="titre pull-left">IMIE Sphère</h2>
        <a href="http://imie-ecole-informatique.fr/"><img class="logoimie pull-right" alt="IMIESpere" src="assets/img/Imie.png" /></a>
    </div>
        ...
        <div class="container-fluid navbar-inverse ">
            ...
            <div class="container">
                <ul class="nav navbar-nav ">
                    ...
                    <li><a href="index.php?action=listUser"><span class="glyphicon glyphicon-user"></span> Gestion utilisateur</a></li>
                    <li><a href="index.php?action=listEvent"><span class="glyphicon glyphicon-align-justify"></span> Evenement</a></li>
                    <li><a href="index.php?action=aboutUs"><span class="glyphicon glyphicon-tower"></span> Nous</a></li>
                </ul>
